...
function RegistroComponent() {
  ...
  const handleRegistro = (e) => {
    ...
    const microSiteData = {
      ventureAddress: formData.get('ventureAddress'),
      ventureDescription: formData.get('ventureDescription'),
      ventureMapLatitude: formData.get('ventureMapLatitude'),
      ventureMapLongitude: formData.get('ventureMapLongitude'),
      ventureName: formData.get('ventureName'),
      microSiteDescription: formData.get('microSiteDescription'),
      micrositeName: formData.get('micrositeName'),
    };
